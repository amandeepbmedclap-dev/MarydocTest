...
export function Hero() {
  return (
    <section id="about" aria-labelledby="hero-heading" className="relative min-h-[calc(100dvh-60px)] overflow-visible scroll-mt-24 sm:min-h-[calc(100dvh-68px)] lg:min-h-[calc(100vh-80px)]">
      <div
      ...
      <div className="relative mx-auto flex min-h-[calc(100dvh-60px)] w-full min-w-0 max-w-[1440px] flex-col px-4 pb-16 pt-6 sm:min-h-[calc(100dvh-68px)] sm:px-6 sm:pb-[4.5rem] sm:pt-8 md:px-8 lg:min-h-[calc(100vh-80px)] lg:flex-row lg:items-center lg:px-10 lg:pb-8 lg:pt-10 xl:px-14 2xl:px-16">
        <div className="flex w-full min-w-0 max-w-full flex-col justify-center pt-2 sm:pt-4 md:max-w-[560px] lg:order-1 lg:w-[54%] lg:max-w-[54%] lg:shrink-0 lg:py-0 lg:pr-4 xl:pr-6">
          ...
          <a
            href="#get-started"
            id="get-started"
            className="hero-fade-in hero-cta mt-6 inline-flex w-fit cursor-pointer items-center justify-center rounded-full bg-[#157a3c] px-8 py-3 text-[13px] font-semibold text-white shadow-[0_10px_28px_rgba(24,138,68,0.35)] transition-all duration-300 hover:bg-[#136b34] hover:shadow-[0_14px_32px_rgba(24,138,68,0.45)] sm:mt-7 sm:px-10 sm:py-3.5 sm:text-[14px] lg:mt-9"
          >
            Let&apos;s start
          </a>
        </div>
