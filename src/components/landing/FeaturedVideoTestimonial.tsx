...
export function FeaturedVideoTestimonial() {
  ...
  return (
    ...
    >
      <div className="relative mx-auto aspect-video w-full overflow-hidden rounded-xl bg-black shadow-[0_16px_40px_rgba(15,81,50,0.18)] sm:aspect-[2/1] sm:rounded-2xl md:aspect-[21/9] md:rounded-3xl lg:rounded-[28px]">
